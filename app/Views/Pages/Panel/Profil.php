                ...
                <div class="card-body">
                    <?= form_open_multipart(base_url('panel/updateprofil') . '/' . $toko['id'], ['method' => 'post', 'autocomplete' => 'off']) ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="store_desc" placeholder="Masukkan Deskripsi" name="store_desc" required><?= html_entity_decode($toko['store_desc']) ?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text"id="store_whatsapp" name="store_whatsapp" placeholder="Format: 628xxxxxxxxxx" value="<?= $toko['store_whatsapp'] ?>" minlength="10">
                        </div>
                        <div class="form-group">
                            <label for="user_whatsapp">WA Pemilik</label>
                            <input class="form-control" type="text"id="user_whatsapp" name="user_whatsapp" placeholder="Format: 628xxxxxxxxxx" value="<?= $toko['user_whatsapp'] ?>" minlength="10">
                        </div>
