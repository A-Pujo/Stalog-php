                            ...
                            <div class="form-row">
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="store_whatsapp" placeholder="Format : 62816xxxxxxxx" name="store_whatsapp" value="62" minlength="10">
                                    </div>
                                </div>
                                <div class="col-md">
                                    <div class="form-group">
                                        <label for="user_whatsapp">Whatsapp Pemilik</label>
                                        <input type="text" class="form-control" id="user_whatsapp" placeholder="Bisa disamakan WA Toko." name="user_whatsapp" value="62" minlength="10">
                                    </div>
                                </div>
                            </div>
